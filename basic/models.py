...
class CategoryManager(models.Manager):
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('sets', 'sushi')
...
class CartProduct(models.Model):
    ...
    cart = models.ForeignKey('Cart', verbose_name='Корзина', on_delete=models.CASCADE, related_name='related_prod')
    ...
    class Meta:
        verbose_name_plural = 'КорзинаПродукт'
...
class Order(models.Model):
    ...
    OPLATA_TYPE_SELF = 'cash'
    OPLATA_TYPE_DELIVERY = 'transaction'
    ...
    OPLATA_TYPE_CHOICES = (
        (OPLATA_TYPE_SELF, 'перевод на карту'),
        (OPLATA_TYPE_DELIVERY, 'Доставка')
    )
    ...
    oplata = models.CharField(
        ...
        choices=OPLATA_TYPE_CHOICES,
        default=OPLATA_TYPE_SELF
    )
